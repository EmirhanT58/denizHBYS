...
<body class="bg-gray-50 text-gray-800 antialiased">
                    ...
                    <div class="ml-3 relative">
                        <div class="flex items-center space-x-2">
                            <div class="text-right hidden md:block">
                                <p class="text-sm font-medium text-gray-700"><?php echo htmlspecialchars($doctor_ad); ?></p>
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 mb-6 card-hover">
                <div class="p-5">
                    <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                        <div>
                            <h2 class="text-xl font-semibold text-gray-800">Hoş Geldiniz, <span class="text-primary-600"><?php echo htmlspecialchars($doctor_ad); ?></span></h2>
                            <p class="text-gray-600 text-sm mt-1">Son giriş: <span class="font-medium"><?php echo $ip . " - " . $girisTarihi; ?></span></p>
                        </div>
                        <div class="mt-4 md:mt-0">
                            <a href="dashboard.php?sayfa=randevular" class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-primary-600 hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 transition-colors">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-4 mb-6">
                ...
                <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-5 lg:col-span-2 card-hover">
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <div class="flex space-x-2">
                            <select class="text-xs border border-gray-300 rounded-md px-3 py-1.5 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500">
                                <option>Bu Hafta</option>
                                <option>Bu Ay</option>
                                <option selected>Bu Yıl</option>
                            </select>
                            <button class="text-gray-500 hover:text-gray-700 p-1 rounded-md hover:bg-gray-100">
                    ...
                    <div class="h-64 bg-gray-50 rounded-md flex items-center justify-center">
                        <div class="text-center p-6">
                            ...
                            <p class="text-gray-500 text-sm">Randevu dağılım grafiği burada gösterilecek</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-5 card-hover">
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <a href="randevular.php" class="text-sm text-primary-600 hover:text-primary-800 hover:underline">Tümünü Gör</a>
                    </div>
                    <div class="space-y-3 max-h-64 overflow-y-auto scrollbar pr-2">
                        ...
                        ?>
                        <div class="flex items-start p-3 border border-gray-100 rounded-md hover:bg-gray-50 transition-colors">
                            <div class="flex-shrink-0 h-10 w-10 rounded-full bg-primary-50 text-primary-600 flex items-center justify-center mt-1">
                                <i class="fas fa-calendar-alt text-sm"></i>
                            </div>
                            <div class="ml-3">
                                <p class="text-sm font-medium text-gray-900"><?= htmlspecialchars($randevu['ad'] . ' ' . $randevu['soyad']) ?></p>
                                <p class="text-xs text-gray-500 mt-0.5"><?= date("d/m/Y H:i", strtotime($randevu['tarih'])) ?></p>
                                <p class="text-xs text-primary-600 mt-1"><i class="far fa-clock mr-1"></i> <?= $kalanText ?> sonra</p>
                            </div>
                        </div>
                        <?php endforeach; 
                        endif; ?>
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-gray-50">
                            <tr>
                                <th scope="col" class="px-5 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Hasta</th>
                                <th scope="col" class="px-5 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Tarih</th>
                                <th scope="col" class="px-5 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Açıklama</th>
                                <th scope="col" class="px-5 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Durum</th>
                                <th scope="col" class="px-5 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider">İşlem</th>
                            </tr>
                        </thead>
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr class="hover:bg-gray-50 transition-colors">
                                <td class="px-5 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        <div class="flex-shrink-0 h-9 w-9 rounded-full bg-gray-200 flex items-center justify-center">
                                            <i class="fas fa-user text-gray-600 text-sm"></i>
                                        </div>
                                        <div class="ml-3">
                                            <div class="text-sm font-medium text-gray-900"><?= htmlspecialchars($randevu['ad'] . ' ' . $randevu['soyad']) ?></div>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td class="px-5 py-4 whitespace-nowrap">
                                    ...
                                    ?>
                                    <span class="px-2.5 py-1 text-xs font-medium rounded-full <?= $renk ?>"><?= ucfirst($durum) ?></span>
                                </td>
                                <td class="px-5 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <div class="flex justify-end space-x-2">
                                        <a href="#" class="text-gray-500 hover:text-primary-700 p-1 rounded-md hover:bg-gray-100">
                                            <i class="fas fa-eye text-sm"></i>
                                        </a>
                                        <a href="#" class="text-gray-500 hover:text-blue-700 p-1 rounded-md hover:bg-gray-100">
    ...
    <div class="md:hidden fixed bottom-0 left-0 right-0 bg-white shadow-lg border-t border-gray-200">
        <div class="flex justify-around">
            ...
            <a href="dashboard.php?sayfa=randevular" class="flex flex-col items-center justify-center p-3 text-gray-500 hover:text-gray-700">
                <i class="fas fa-calendar-check text-lg"></i>
                <span class="text-xs mt-1">Randevular</span>
            </a>
            <a href="dashboard.php?sayfa=hastalar" class="flex flex-col items-center justify-center p-3 text-gray-500 hover:text-gray-700">
                <i class="fas fa-user-injured text-lg"></i>
                <span class="text-xs mt-1">Hastalar</span>
            </a>
            <a href="dashboard.php?sayfa=ayarlar" class="flex flex-col items-center justify-center p-3 text-gray-500 hover:text-gray-700">
